...
{
    // NOTA: puede usar el comando "Rename" del menú "Refactorizar" para cambiar el nombre de clase "notaDebitoParticular" en el código, en svc y en el archivo de configuración a la vez.
    // NOTA: para iniciar el Cliente de prueba WCF para probar este servicio, seleccione notaDebitoParticular.svc o notaDebitoParticular.svc.cs en el Explorador de soluciones e inicie la depuración.
    public class notaDebitoParticular : InotaDebitoParticular
    {
...
WHERE IdMovimiento = @idMovimiento";
                ...
                try
                {
                    ...
                    string strsb = lectorDatos.ReadToEnd();
