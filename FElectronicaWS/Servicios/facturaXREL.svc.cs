...
WHERE B.idcontrato is null and A.IdLocalizaTipo=1 and A.indhabilitado=1 and D.IdFactura=@idFactura";
                ...
                */
                ...
                using (SqlConnection conn = new SqlConnection(Properties.Settings.Default.DBConexion))
                {
                    ...
                    //itemExtensionSalud.cuotaModeradora = 0;
                    itemExtensionSalud.tipoDocumentoIdentificacion = " ";
                    itemExtensionSalud.tipoDeUsuario ="CC";
                    itemExtensionSalud.numeroIdentificacion = "123456789";
                    itemExtensionSalud.cobertura = "Presupuesto maximo";
                    itemExtensionSalud.codigoPrestador="CPFE";
                    //itemExtensionSalud.copago=0;
                    //itemExtensionSalud.cuotaModeradora=0;
                    //itemExtensionSalud.cuotaRecuperacion=0;
                    itemExtensionSalud.fechaFinFacturacion= DateTime.Now.ToString("yyyy-MM-dd");
                    itemExtensionSalud.fechaInicioFacturacion=DateTime.Now.ToString("yyyy-MM-dd");
                    itemExtensionSalud.numeroPoliza = "Poliza#";
                    itemExtensionSalud.primerNombre = "Nomobre2";
                    itemExtensionSalud.otrosNombres = "Nombre2";
                    itemExtensionSalud.primerApellido = "Apellido 1";
                    itemExtensionSalud.segundoApellido = "Apellido 2";
                    itemExtensionSalud.modalidadesContratacion = "Por Servicio";
