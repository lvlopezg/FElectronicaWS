...
WHERE c.val_unit_inte is null and NumDocRespaldo = @idFactura ORDER BY c.num_regi";
                    ...
                    if (rdDetalleFac.HasRows)
                    {
                        ...
                        while (rdDetalleFac.Read())
                        {
                            try
                            {
                                ...
                                lineaProducto.valorBruto = double.Parse(rdDetalleFac.GetSqlMoney(5).ToString()) * double.Parse(rdDetalleFac.GetInt32(3).ToString());
                                ...
                                tributosWRKIva.valorBase = double.Parse(rdDetalleFac.GetSqlMoney(5).ToString()) * double.Parse(rdDetalleFac.GetInt32(3).ToString());
                ...
                Totales totalesTmp = new Totales()
                {
                    ...
                    valorNeto = double.Parse(valorBase.ToString())- double.Parse(_ValPagos.ToString())+ double.Parse(valorImporte.ToString()) //double.Parse(_ValCobrar.ToString())
                };
