...
WHERE A.IndHabilitado=1 AND  A.idfactura= @nroFactura";
				...
				{
					connx.Open();
					string qryDatosCliente = @"select c.idtercero,b.idcontrato,a.Nomtercero,a.TaxTercero,a.DirTercero,a.CityTercero,a.TelTercero 
...
where a.indhabilitado=1 and  a.idfactura=@idFactura";
					...
					{
						rdDatosCliente.Read();
						_razonSocial = rdDatosCliente.GetString(2);
						_direccionCliente = rdDatosCliente.GetString(4);
						_numDocCliente = rdDatosCliente.GetString(3);
						_municipioCliente = rdDatosCliente.GetString(5);
						_telefonoCliente = rdDatosCliente.GetString(6);
					}
